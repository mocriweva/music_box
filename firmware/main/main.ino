...
// --- 全自動校正與動態比例門檻參數 ---
int baseline_white[7] = {0}; 
int baseline_black[7] = {0}; 
int jump_up[7] = {0};   // 動態算出的高門檻 (60%)
int jump_down[7] = {0}; // 動態算出的低門檻 (40%)
...
void calibrateSensors() {
    ...
    for (int i = 0; i < 7; i++) baseline_white[i] = temp_sum[i] / samples;
